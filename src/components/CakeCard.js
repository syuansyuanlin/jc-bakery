      ...
      <ul className="row">
        {cakes.map((cake, index) => (
          <li key={cake.name} className="card col m-1 p-1">
            <img className="card-img-top" src={images(`./cake${index + 1}.jpg`)} alt=""></img>

            <div className="card-body" style={{ fontSize: 14, color: "rgb(89, 69, 69)" }}>
              {/* 商品名稱 */}
              <div style={{ fontSize: 16, color: "rgb(70, 78, 46)" }} className="p-1">
                {cake.name}
              </div>
              {/* 價格 */}
              ...
              <a href="#" class="btn btn-light" style={{ backgroundColor: "rgb(150, 126, 118)",
                  fontSize: 14, color: "rgb(254, 251, 246)",}}>
                加入購物車
              </a>
            </div>
          </li>
